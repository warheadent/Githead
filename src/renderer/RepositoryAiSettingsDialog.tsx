...
function createDraft(result: RepositoryAiSettings): RepositoryAiSettingsDraft {
  return {
    ...
    commitPlanModels: mapProviders((provider) => result.settings.providers[provider].commitPlanModel ?? ""),
    commitPlanReasoningEfforts: mapProviders((provider) => result.settings.providers[provider].commitPlanReasoningEffort),
