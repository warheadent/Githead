export const IPC_CHANNELS = {
  ...
  getGitConfig: "git:config:get",
  saveGitConfig: "git:config:save",
  testGitSigning: "git:config:test-signing",
  chooseGitConfigFile: "git:config:choose-file",
  getGitIgnoreFile: "git:config:get-ignore",
  saveGitIgnoreFile: "git:config:save-ignore",
